...
import { Cloud, Mail, MapPin, Phone, Github, Twitter, Linkedin } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">AI Climate Intelligence</p>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/forecast" className="text-gray-400 hover:text-white transition-colors">
                  Weather Forecast
                </Link>
              </li>
              {/* <li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">info@climateai.online</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="h-4 w-4 text-gray-400" />
                <span className="text-gray-400 text-sm">+91 6202865664</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-4 w-4 text-gray-400" />
                <span className="text-gray-400 text-sm">Uttar Pradesh, India</span>
              </div>
            </div>
          </div>
        </div>
